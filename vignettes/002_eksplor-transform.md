...
``` r
sum(iris$Petal.Length) # menghitung jumlah
```

    ## [1] 563.7

``` r
cor(iris[, -5]) # menghitung korelasi
```
...
1.  memanggil data storms (jenis storms, tahun,bulan, wind, pressure )
2.  memilih baris : storms antara tahun 2000 sampai 2015
3.  mengubah variabel bulan, dari angka menjadi nama bulan
4.  mengelompokkan data berdasarkan bulan
5.  melakukan perhitungan, jumlah, rata-rata
